...
public interface ProductRepository extends JpaRepository<Product, Integer> {
	...
	// 'available' and other filters with or without and without in selected supplier
	...
	public List<Product> getAvailableProducts(@Param("supplierid") Integer supplierId,@Param("brandname")String brandName,@Param("categoryname")String categoryName,@Param("subcategoryname")String subCategoryName);
