...
public interface SupplierRepository extends JpaRepository<Supplier, Integer>{
	...
	@Query(value = "Select new Supplier(s.id,s.firstName,s.lastName,s.company,s.contact,s.email) from Supplier s where s.supplierStatusId = (Select supstatus from SupplierStatus supstatus where name='Active') order by s.id desc")
