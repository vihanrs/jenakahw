...
public class Invoice {
	...
	@OneToMany(mappedBy = "invoiceId", cascade = CascadeType.ALL, orphanRemoval = true) //map with invoiceId foreign key property in InvoiceHasProduct object, use cascade all to access all operations in invoice_has_product table
